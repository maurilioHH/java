...
insert into album (singer_id, title, release_date) values (1, 'Paradise Valley', '2013-08-19');
insert into album (singer_id, title, release_date) values (1, 'Born and Raised', '2012-05-22');
